var hexoThemeBasis = (function (exports) {
'use strict';
  ...
  createClass(BasisHamburgerBtn, [{
    ...
    value: function setListener() {
      this.hamburgerBtn.each(function (i, e) {
        var hamburgerBtn = jquery(e);
        var target = jquery('#' + hamburgerBtn.attr('aria-controls'));
  ...
  createClass(BasisDrawer, [{
    ...
    value: function setListener() {
      ...
      this.drawer.each(function (i, e) {
        ...
        var btn = jquery('#' + drawer.attr('aria-labelledby'));
        ...
        toggleBtns.each(function (i, e) {
          var toggleBtn = jquery(e);
          var submenu = jquery('#' + toggleBtn.attr('aria-controls'));
    ...
    value: function toggleMenu(btn) {
      var menu = jquery('#' + btn.attr('aria-controls'));
...
var BasisNavbar = function () {
  ...
  createClass(BasisNavbar, [{
    ...
    value: function setListener() {
      ...
      jquery(this.args.item).each(function (i, e) {
        var item = jquery(e);
 ...
 */
var hamburgerBtn = new BasisHamburgerBtn();

var drawer = new BasisDrawer();

var navbar = new BasisNavbar();

var pageEffect = new BasisPageEffect();

var select = new BasisSelect();

exports.hamburgerBtn = hamburgerBtn;
